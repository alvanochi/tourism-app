...
class MapsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Kode di atas digunakan untuk memanggil module secara manual,
        //hal ini karena koin tidak dapat memanggil module yang di dalam dynamic feature module
        //sejak awal melalui startKoin yang ada di MyApplication.
        //jika tidak menggunakan ini maka akan error
